...
import {FeatureType, GenerateCmd} from "../../../src/index.js";
...
describe("Generate AsyncFactory", () => {
  ...
  it("should generate project with premium features", async () => {
    await CliPlatformTest.initProject({
      features: [FeatureType.CONFIG],
      featuresConfig: [FeatureType.CONFIG_AWS_SECRETS],
      GH_TOKEN: "token"
    });
